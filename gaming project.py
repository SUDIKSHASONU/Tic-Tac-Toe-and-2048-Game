...
//function to remove a number left of the number in given position and arrange the
...
//function to remove a number right of the number in given position and arrange
...
//function to remove a number top of the number in given position and arrange

void removeup(int row,int column)
{
    top[column]=top[column]-1;
}
//function to check and remove the item and replace numbers with appropriate
...
//function to check wheter any column is full(overflow conndition) to check
